        ...
        <div className="px-6 py-8 space-y-8">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              This Privacy Policy outlines how FARM-FRIEND AI collects, uses, and protects your personal information when you utilize our agricultural services. By using our services, you consent to the practices described in this policy.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              The information we collect is used to enhance our services, provide accurate soil quality predictions, and offer personalized guidelines for farmers. We may also use it to communicate updates or changes to our services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              We do not share your personal information with third parties unless required by law or to protect our rights and services. In such cases, we will take all necessary steps to ensure that your data is safeguarded.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              We implement robust security measures to protect your data from unauthorized access, alteration, or disclosure. However, no system can guarantee complete security, and we cannot ensure the absolute safety of your information.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              You have the right to access, correct, or delete the personal data we hold about you. If you wish to exercise these rights, please contact us using the details provided below.
            </p>
          </section>
          ...
          <section>
            ...
            <address className="mt-2 not-italic text-green-700">
              FARM-FRIEND AI<br />
              Jaipur, Rajasthan<br />
              Email: privacy@farmfriend.com<br />
              Phone: (555) 123-4567
            </address>
          </section>
        </div>
