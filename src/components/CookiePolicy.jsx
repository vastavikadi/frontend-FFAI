        ...
        <div className="px-6 py-8 space-y-8">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Cookies are small pieces of data stored on your device (computer or mobile device) when you visit a website. They are widely used to make websites function efficiently and to provide information to the site owners.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              We use cookies on our FARM-FRIEND AI website for the following purposes:
            </p>
            <ul className="list-disc list-inside text-gray-700 leading-relaxed">
              <li>To provide personalized soil quality predictions and farming guidelines</li>
              <li>To remember your preferences and settings</li>
              <li>To enhance the performance and functionality of our website</li>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-700">These help us understand how visitors interact with our website, allowing us to enhance its functionality.</p>
              </div>
              <div>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              We may also use third-party cookies, such as Google Analytics, to analyze how users interact with the site and to improve our services. These third-party cookies are subject to their own privacy policies.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              Most web browsers allow you to control cookies through their settings preferences. However, limiting cookies may affect your experience on our website. You can manage your cookie preferences in the following ways:
            </p>
            <ul className="list-disc list-inside text-gray-700 leading-relaxed">
              <li>Browser settings: Usually found in the 'options' or 'preferences' menu of your browser</li>
              <li>Cookie management tools: Options available on our website to manage your cookie preferences</li>
              <li>Third-party opt-out: For third-party cookies, visit the respective website to opt out</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <address className="mt-2 not-italic text-green-700">
              FARM-FRIEND AI<br />
              Jaipur, Rajasthan<br />
              Email: privacy@farmfriendai.com<br />
              Phone: (555) 987-6543
            </address>
          </section>
        </div>
