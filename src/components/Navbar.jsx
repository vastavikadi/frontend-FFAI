...
const Navbar = () => {
  ...
  return (
    <nav ref={navbarRef} className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 w-full z-50 top-0 fixed">
      <div className="max-w-screen-2xl flex flex-wrap items-center font-semibold justify-between mx-auto p-3">
        ...
        <div className="text-white font-bold flex items-center">
          <Link to="/" onClick={closeMenu}>
            ...
            <span className="px-2 text-xl">FARM-FRIEND AI</span>
          </Link>
        </div>
        ...
        <div className={`${isMenuOpen ? "block" : "hidden"} w-full lg:flex lg:w-auto lg:items-center transition-all duration-300 ease-in-out`}>
          <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-4">
            ...
            {/* Other Links */}
            <NavLink to="/DiseaseRecognition" className={({ isActive }) => `block py-2 px-3 text-white rounded-lg transition-all duration-300 ${isActive ? "bg-green-700" : "hover:bg-green-500"}`} onClick={closeMenu}>Disease Detection</NavLink>
            ...
            <div className="relative">
              ...
              {openDropdown === "help" && (
                <div className="absolute left-0 mt-2 w-60 bg-white text-black rounded-lg shadow-lg z-50">
                  ...
                  <NavLink to="/article" className="block py-2 px-4 hover:bg-gray-200" onClick={closeMenu}>Articles</NavLink>
